/*global history */
sap.ui.define([
		"employeeattrition/controller/BaseController",
		...
		return BaseController.extend("employeeattrition.controller.Master", {
			...
			onSearch : function (oEvent) {
				...
				if (sQuery) {
					this._oListFilterState.aSearch = [new Filter("Age", FilterOperator.Contains, sQuery)];
				} else {
