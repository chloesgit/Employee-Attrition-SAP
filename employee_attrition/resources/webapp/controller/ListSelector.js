sap.ui.define([
		...
		return BaseObject.extend("employeeattrition.model.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias employeeattrition.model.ListSelector
			 */
			 ...
			 * @return {employeeattrition.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
