sap.ui.define([
		...
		return BaseObject.extend("attrition.model.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias attrition.model.ListSelector
			 */
			 ...
			 * @return {attrition.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
