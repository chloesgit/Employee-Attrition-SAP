							...
							success : function (aEntityData) {
								this.waitFor({
									...
									success : function (oList) {
										...
										oCurrentItem.bindingPath = "/" + oList.getModel().createKey("employees_names", {
				...
				assertions : {
					...
					theListHeaderDisplaysZeroHits : function () {
						return this.waitFor({
							viewName : sViewName,
							id : "page",
							matchers : new PropertyStrictEquals({name : "title", value : "employees_names (0)"}),
							success : function () {
								Opa5.assert.ok(true, "The list header displays 'employees_names (0)'");
							},
					...
					theListShouldHaveAllEntries : function () {
						...
						// retrieve all employees_names to be able to check for the total amount
						...
						return this.waitFor({
							...
							success : function (oList) {
								...
								this.waitFor({
									id : "page",
									viewName : sViewName,
									matchers : new PropertyStrictEquals({name : "title", value : "employees_names (" + iExpectedLength + ")"}),
									success : function () {
