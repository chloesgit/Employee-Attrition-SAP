sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("attrition/app", ".html");
			sHash = sHash || "";
		...
		return Opa5.extend("attrition.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["attrition/localService/mockserver"], function (mockserver) {
