/*global history */
sap.ui.define([
		"employeefiori/controller/BaseController",
		...
		"sap/ui/Device",
		"employeefiori/model/formatter",
		"employeefiori/model/grouper",
		"employeefiori/model/GroupSortState"
		...
		return BaseController.extend("employeefiori.controller.Master", {
			...
			onOpenViewSettings : function () {
				if (!this._oViewSettingsDialog) {
					this._oViewSettingsDialog = sap.ui.xmlfragment("employeefiori.view.ViewSettingsDialog", this);
