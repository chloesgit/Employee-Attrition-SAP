sap.ui.define([
		...
		return BaseObject.extend("employeefiori.model.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias employeefiori.model.ListSelector
			 */
			 ...
			 * @return {employeefiori.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
