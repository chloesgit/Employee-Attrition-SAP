sap.ui.define([
		...
		return BaseObject.extend("dashboard.model.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias dashboard.model.ListSelector
			 */
			 ...
			 * @return {dashboard.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
