sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("dashboard/app", ".html");
			sHash = sHash || "";
		...
		return Opa5.extend("dashboard.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["dashboard/localService/mockserver"], function (mockserver) {
