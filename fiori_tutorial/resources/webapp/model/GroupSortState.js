sap.ui.define([
	...
	return BaseObject.extend("dashboard.model.GroupSortState", {
		 ...
		 * @alias dashboard.model.GroupSortState
		 */
		...
		/**
		 * Sorts by Surname, or by Attrition
		 *
		...
		group: function (sKey) {
			...
			if (sKey === "Attrition") {
				...
				this._oViewModel.setProperty("/sortBy", "Surname");
			}
