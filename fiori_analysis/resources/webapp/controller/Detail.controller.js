...
sap.ui.define([
		...
		return BaseController.extend("employeesdashboard.controller.Detail", {
			...
			_onObjectMatched : function (oEvent) {
				...
				this.getModel().metadataLoaded().then( function() {
					var sObjectPath = this.getModel().createKey("employeesanalysis", {
